...
public class test10Student3TablesHeterogeneous {
	...
	public void test() {
		...
		// Select an heterogeneous typeOfGroup
		int type = 2;
		...
		table1Sorted.addStudent(s4);
		table1Sorted.addStudent(s6);
		table1Sorted.addStudent(s8);
		
		Table table2Sorted = new Table();
		table2Sorted.addStudent(s2);
		table2Sorted.addStudent(s5);
		table2Sorted.addStudent(s9);
		
		Table table3Sorted = new Table();
		table3Sorted.addStudent(s3);
		table3Sorted.addStudent(s6);
		table3Sorted.addStudent(s10);
